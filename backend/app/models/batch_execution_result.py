...
class BatchExecutionResult(Base):
    ...
    recovery_owner_id = Column(UUID(as_uuid=True), nullable=True, index=True)
    recovery_status = Column(String, nullable=False, default="unassigned")
    lifecycle_stage = Column(String, nullable=False, default="not_started", index=True)
    ...
    enrollment_outcome = Column(String, nullable=True)
